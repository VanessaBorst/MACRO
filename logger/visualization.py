...
class TensorboardWriter:
    def __init__(self, log_dir, logger, enabled):
        ...
        if enabled:
            ...
            if not succeeded:
                message = "Warning: visualization (Tensorboard) is configured to use, but currently not installed on " \
                    "this machine. Please install TensorboardX with 'pip install tensorboardX' or turn off the option in the 'config.json' file."
        ...
        self.tb_writer_ftns = {
            ...
            'add_text', 'add_histogram', 'add_pr_curve', 'add_embedding', 'add_figure', 'add_graph'
        }
