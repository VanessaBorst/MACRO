...
from layers.ContextualAttention import ContextualAttention, MultiHeadContextualAttention, \
    MultiHeadContextualAttentionV2, MultiHeadContextualAttentionV3
from utils import plot_record_from_np_array


class BaselineModelWithMHAttentionNovelQuery(BaseModel):
...
if __name__ == "__main__":
    model = BaselineModelWithMHAttentionNovelQuery(apply_final_activation=True, multi_label_training=True, gru_units=12)
