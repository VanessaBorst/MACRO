    ...
    def __init__(self,
        ...
        final_model_single_leads = [
            FinalModel(
                ...
                discard_FC_before_MH=branchNet_discard_FC_before_MH,
        ...
        self._multi_head_contextual_attention = _get_attention_module(
            discard_FC_before_MH=multi_branch_discard_FC_before_MH,
            dropout_attention=multi_branch_attention_dropout,
            d_model=d_model,
...
#
# class FinalModelBranchNetOld(BaseModel):
#     def __init__(self,
