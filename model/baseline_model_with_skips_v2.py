...
class BaselineModelWithSkipConnectionsV2(BaseModel):
    def __init__(self, apply_final_activation, multi_label_training, input_channel=12, num_classes=9,
        ...
        if pos_skip == "all" or pos_skip == "not_last":
            self._first_conv_block_1 = BasicBlock1d(in_channels=input_channel, out_channels=out_channel_block_1,
        ...
        self._first_conv_block_2 = BasicBlock1d(in_channels=out_channel_block_1, out_channels=out_channel_block_2,
                                                mid_kernels_size=mid_kernel_size_first_conv_blocks,
                                                last_kernel_size=last_kernel_size_first_conv_blocks,
                                                stride=stride_first_conv_blocks,
                                                down_sample=down_sample,
                                                drop_out=drop_out_first_conv_blocks,
                                                skips_active=True)
        self._first_conv_block_3 = BasicBlock1d(in_channels=out_channel_block_2, out_channels=out_channel_block_3,
                                                mid_kernels_size=mid_kernel_size_first_conv_blocks,
                                                last_kernel_size=last_kernel_size_first_conv_blocks,
                                                stride=stride_first_conv_blocks,
                                                down_sample=down_sample,
                                                drop_out=drop_out_first_conv_blocks,
                                                skips_active=True)
        self._first_conv_block_4 = BasicBlock1d(in_channels=out_channel_block_3, out_channels=out_channel_block_4,
                                                mid_kernels_size=mid_kernel_size_first_conv_blocks,
                                                last_kernel_size=last_kernel_size_first_conv_blocks,
                                                stride=stride_first_conv_blocks,
                                                down_sample=down_sample,
        ...
        if pos_skip == "all" or pos_skip == "not_first":
            self._second_conv_block_1 = BasicBlock1d(in_channels=out_channel_block_4, out_channels=out_channel_block_5,
